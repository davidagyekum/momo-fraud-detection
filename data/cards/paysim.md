...
- Class distribution: canonical page displays 8,213 positive `isFraud` values; this remains a reference expectation, not measured repository evidence, until the registered file is hashed and profiled
