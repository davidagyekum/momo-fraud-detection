...
- Added the logical PR16 private Ghana screenshot foundation: owner/friend permission-state intake, pseudonymous participant/source groups, metadata-stripped working-copy controls, exact/perceptual duplicate quarantine, staged de-identification, auditable review transitions, withdrawal propagation, group-safe split freezing, online-candidate rights quarantine and an output-free Colab dataset notebook. A private ten-file friend pilot indexed eight conservative groups and quarantined one exact duplicate. Six online candidates were separately indexed with no exact/perceptual duplicates and permission owner-attested for five. Second review approved ten fraud, two genuine and one suspicious labels, excluded two ambiguous records, and replaced the mixed image with two same-group redacted crops. De-identified transcription/field/mask QA accepted 12 records across 10 source groups and rejected one for low masked-image utility; deterministic regeneration removed residual ICC metadata. Split freezing now enforces explicit eligibility and the 30 controlled-real/20 synthetic-clean pilot minimum. No split or training occurred.
