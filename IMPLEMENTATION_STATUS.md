...
- PR13 corrected Colab pin SHA: `bdb5b7a57ce5e2aaeda929f7f2ab236acdbc43c8`
...
- Next exact task: `Run the corrected pinned PaySim registration notebook at bdb5b7a in owner-operated Colab, preserve the first quarantine evidence, and record the new registered/quarantined manifest. Stop before splits, locked tests or training.`
...
8. Run only the corrected owner-operated Colab registration pin `bdb5b7a57ce5e2aaeda929f7f2ab236acdbc43c8` at code SHA `af248bd6b71e77bdf9ddaa4dc3457856f1cff87a`. Do not create splits, access locked tests or execute FULL training.
