...
| PR16-GHANA-PRIVATE | Logical PR16 | Independent text review approves 265 owner-account texts plus 13 screenshot-OCR rows; MTN/Telecel/account diversity does not create independent participants. The balanced synthetic-clean pilot supplies 30 groups/90 rows but still requires second review. The screenshot pilot remains only 10 controlled-real groups versus the enforced 30-group minimum, and image 6 remains unpermitted. | Ghana split freezing and adaptation cannot start; no current record is training eligible. | Keep all owner accounts train-only candidates, Ghana-private disabled/non-training and private indexes outside Git. | Project owner/data steward expands permission-attested fraudulent/suspicious source groups and reviews the synthetic pilot. | Add at least 20 distinct fraudulent/suspicious controlled-real source groups, review all synthetic rows, then explicitly enable eligible records and freeze group-safe splits before Colab training. |
...
- Handoff file: `docs/handoffs/2026-08-14-PR16-android-owner-messages.md`
- Summary: `Normalized the owner-controlled Android MTN/Telecel XML exports, removed cross-export overlaps, regenerated and independently reviewed the combined 278-row real-text layer, and stopped with every record non-training and all splits unfrozen.`
...
8. Preserve the completed second-review artifact for 278 real de-identified text rows and the 30-group synthetic-clean pilot. Review the 90 synthetic records and expand controlled-real fraudulent/suspicious screenshot groups to at least 30 before any eligibility or split-freeze decision. No raw private data, consent record or downloaded image may enter Git.
